...
for (const file of ['engine.mjs', 'browser-runtime.mjs', 'pages-state.mjs', 'market-universe.mjs', 'strategies.mjs']) fs.copyFileSync(path.join(root, file), path.join(out, file));
